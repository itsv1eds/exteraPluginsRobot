...
TEXTS: Dict[str, Dict[str, str]] = {
    ...
    "admin_btn_audit": {"ru": "Аудит заявок", "en": "Requests audit"},
    "admin_audit_title": {
        "ru": "<b>📋 Аудит заявок</b>  (стр. {current}/{total}, всего {count})",
        "en": "<b>📋 Requests audit</b>  (page {current}/{total}, total {count})",
    },
    "admin_audit_empty": {"ru": "Пока пусто.", "en": "Empty."},
